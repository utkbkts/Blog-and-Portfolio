...
import { useVerifyMutation } from "../../redux/api/userApi";
...
const VerifyEmail = () => {
  ...
  const [codeVerify, { isLoading, isSuccess, error }] = useVerifyMutation();
          ...
          <div className="flex justify-between">
            {code.map((digit, index) => (
              <input
                ...
                className="w-12 h-12 text-center text-2xl font-bold bg-gray-700 text-black border-2 border-gray-600 rounded-lg focus:border-green-500 focus:outline-none"
              />
            ))}
          </div>
          {error && (
